...
// Grave
const graveColorTexture = textureLoader.load('/grave/dirty_concrete_1k/dirty_concrete_diff_1k.webp');
const graveARMTexture = textureLoader.load('/grave/dirty_concrete_1k/dirty_concrete_arm_1k.webp');
const graveNormalTexture = textureLoader.load('/grave/dirty_concrete_1k/dirty_concrete_nor_gl_1k.webp');
...
const tick = () =>
{
    ...
    ghost3.position.y = Math.sin(ghost3Angle) * Math.sin(ghost3Angle * 2.34) * Math.sin(ghost3Angle * 3.45) * 2;
